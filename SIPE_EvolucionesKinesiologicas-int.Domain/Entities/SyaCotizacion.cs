...
{
    public partial class SyaCotizacion
    {
        public SyaCotizacion()
        {
            SyaCambiosEstadoCotizacions = new HashSet<SyaCambiosEstadoCotizacion>();
            SyaDatosComplementariosCotizacionDomesticas = new HashSet<SyaDatosComplementariosCotizacionDomestica>();
            SolicitudesCostosCompartidosNav = new HashSet<SyaSolicitudesCostosCompartido>();
            UnidadComercialesNav = new HashSet<SyaCotizacionUnidadComercial>();
    }
        ...
        public virtual ICollection<SyaCambiosEstadoCotizacion> SyaCambiosEstadoCotizacions { get; set; }
        public virtual ICollection<SyaDatosComplementariosCotizacionDomestica> SyaDatosComplementariosCotizacionDomesticas { get; set; }
        public virtual ICollection<SyaSolicitudesCostosCompartido> SolicitudesCostosCompartidosNav { get; set; }
        public virtual ICollection<SyaCotizacionUnidadComercial> UnidadComercialesNav { get; set; }
    }
}
