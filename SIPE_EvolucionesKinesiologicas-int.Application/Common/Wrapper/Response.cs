...
namespace SIPE_Evolucion.Application.Common.Wrapper
{
    public class Response : IWrapperResponse
    {
        public Response()
        {
        }
        ...
        public static IWrapperResponse Fail()
        {
            return new Response { Succeeded = false };
        }

        public static IWrapperResponse Fail(string message)
        {
            return new Response { Succeeded = false, Messages = new List<string> { message } };
        }

        public static IWrapperResponse Fail(List<string> messages)
        {
            return new Response { Succeeded = false, Messages = messages };
        }

        public static Task<IWrapperResponse> FailAsync()
        {
            return Task.FromResult(Fail());
        }

        public static Task<IWrapperResponse> FailAsync(string message)
        {
            return Task.FromResult(Fail(message));
        }

        public static Task<IWrapperResponse> FailAsync(List<string> messages)
        {
            return Task.FromResult(Fail(messages));
        }

        public static IWrapperResponse Success()
        {
            return new Response { Succeeded = true };
        }

        public static IWrapperResponse Success(string message)
        {
            return new Response { Succeeded = true, Messages = new List<string> { message } };
        }

        public static IWrapperResponse Success(List<string> messages)
        {
            return new Response { Succeeded = true, Messages = messages };
        }

        public static Task<IWrapperResponse> SuccessAsync()
        {
            return Task.FromResult(Success());
        }

        public static Task<IWrapperResponse> SuccessAsync(string message)
        {
            return Task.FromResult(Success(message));
        }

        public static Task<IWrapperResponse> SuccessAsync(List<string> messages)
        {
